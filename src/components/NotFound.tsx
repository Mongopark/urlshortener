  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="text-center max-w-md">
        ...
        <Link
          to="/auth"
          className="inline-flex items-center px-4 py-2 mt-8 text-white bg-secondary rounded-md hover:bg-secondary focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
        >
          Go Back Home
          <svg
